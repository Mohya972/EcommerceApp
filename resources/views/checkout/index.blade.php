...
@section('content')
    ...
    <h1 class="text-3xl font-bold mb-8"> Récapitulatif de la Commande</h1>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2">
            <form action="{{ route('checkout.process') }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text" 
                                ...
                                required
                                class="w-full border-gray-300 rounded-lg focus:border-green-500 focus:ring focus:ring-green-200">
                            @error('shipping_name')
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="shipping_address" 
                                rows="3"
                                required
                                class="w-full border-gray-300 rounded-lg focus:border-green-500 focus:ring focus:ring-green-200">{{ old('shipping_address', auth()->user()->address) }}</textarea>
                ...
                <button type="submit" 
                        class="w-full bg-green-600 hover:bg-green-700 text-white font-bold py-4 px-6 rounded-lg transition shadow-lg hover:shadow-xl">
            ...
            <div class="bg-white rounded-lg shadow p-6 sticky top-4">
                ...
                <div class="border-t pt-4">
                    <div class="flex justify-between items-center">
                        ...
                        <span class="text-2xl font-bold text-green-600">{{ $cart->formatted_total }}</span>
                    </div>
                </div>
            </div>
        </div>
